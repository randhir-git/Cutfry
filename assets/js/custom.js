...
//------------main menu made by Randhir Singh 2-August-2018
  //$('#mainmenu > li > a').on('mouseover',function(){ //main menu open 
  $(document).on('mouseover','#mainmenu > li > a',function(){ //main menu open 

      $('#mainmenu > li > div.dropdown-menu').css('display','none');
      $(this).parent().find('>div.dropdown-menu').css('display','block');

      $(this).parent().find('>div.dropdown-menu') // sub level menu should work same as main
      .mousemove(function(){
          
        $(this).find('>div.dropdown-menu').css('display','block');
          $(this).parent().find('ul > li:has(div.dropdown-menu)')
          .mouseover(function(){
            $(this).find('>div.dropdown-menu').css('display','block');
          })
          .mouseleave(function(){$(this).find('>div.dropdown-menu').css('display','none')});
        })
      .mouseleave(function(){$(this).css('display','none')});
  });

//   $(document).on('mouseover','.catlink',function(){ //second Level Menu open 

//     $('.catlink').parent().find(' > div.dropdown-menu').css('display','none');
//     $(this).parent().find('> div.dropdown-menu').css('display','block');
    

//     $(this).parent().find('>div.dropdown-menu') // Third Level Menu should work same as main
//     .mousemove(function(){
//               $(this).find('>div.dropdown-menu').css('display','block');
//         }).mouseleave(function(){
...
$('span.submore').click(function (e) {
        ...
        $parentli.siblings('li, .column').find('http://demo.harnishdesign.net/html/bigshop/v2/js/span.submore.plus').toggleClass('plus');
